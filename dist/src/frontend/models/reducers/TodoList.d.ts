...
export declare const itemsSelectorFn: (state: ITodoList) => any[];
...
export declare const listToDisplaySelectorFnCreator: () => import("reselect").OutputSelector<ITodoList, any[], (res1: any[], res2: SortOrder, res3: number, res4: number) => any[]>;
export declare const listToDisplaySelector: import("reselect").OutputSelector<ITodoList, any[], (res1: any[], res2: SortOrder, res3: number, res4: number) => any[]>;
