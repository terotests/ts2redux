...
*   Generated by ts2redux at 2018-10-20T13:25:05.913Z                           *
...
export class IncModelProvider extends React.Component {
  ...
  increment(){
    this.setState(immer.produce( this.state, draft => ( new RIncModel(draft) ).increment() ))
  }
  decrement(){
    this.setState(immer.produce( this.state, draft => ( new RIncModel(draft) ).decrement() ))
  }
  render() {
