...
export class RTodoList {
  ...
  set sortColumn(value:SortColumns) {
    if(this._state) {
      this._state.sortColumn = value
    } else {
      // dispatch change for item sortColumn
      this._dispatch({type:TodoListEnums.TodoList_sortColumn, payload:value})
    }
  }
  ...
  set filterType(value:FilterTypes) {
    if(this._state) {
      this._state.filterType = value
    } else {
      // dispatch change for item filterType
      this._dispatch({type:TodoListEnums.TodoList_filterType, payload:value})
    }
  }
  ...
  return immer.produce(state, draft => {
    switch (action.type) {
      ...
      case TodoListEnums.TodoList_stateError: 
        ...
        break;
      case TodoListEnums.TodoList_sortColumn: 
        (new RTodoList(draft)).sortColumn = action.payload
        break;
      case TodoListEnums.TodoList_filterType: 
